...
var myLodash = JSON.parse(myTest);

var skills3 = _.map(myLodash, 'skills');
var skills2 = _.flatten(skills3, 'skills');
var skills1 = _.uniq(skills2, 'skills');
var skills = _.sortBy(skills1);
console.log('Skills:',skills);

var names3 = _.orderBy(myLodash, 'friends.length');
var names2 = _.map(names3,'name');
var names1 = _.map(names3,'friends.length');
var names = _.zipObject(names2,names1);
console.log('Number of friends:',names);

var friend3 = _.map(myLodash, 'friends');
var friend2 = _.flatten(friend3, 'name');
var friend1 = _.map(friend2, 'name');
var friend = _.uniq(friend1);
console.log("Friends' names:",friend);
